...
\usepackage{tikz}
\usetikzlibrary{positioning, arrows.meta, arrows, decorations.pathreplacing, automata, shapes, calc, intersections, fit}
\usepackage{pgfplots}
...
% shamelessly stolen from https://castel.dev/post/lecture-notes-2/#including-inkscape-figures-in-a-latex-document
...
\newtcolorbox{backpagenotice}{
    ...
    coltitle=white,
    attach boxed title to top left={yshift*=-\tcboxedtitleheight}, 
    title=\textsc{Freely Given, Highly Questionable},
    parbox=false,
    breakable,
    arc=2pt,
    boxed title size=title,
...
\newcommand{\makedocumentbackpage}{
    ...
    % --- Force jump to the next EVEN (left) page ---
    \clearpage
    \ifodd\value{page}\else
        ...
        \vfill
        % \begin{center}
        %     This page has intentionally been left blank because aesthetics. Go use a 2-sided, facing page PDF viewer.
        % \end{center}
        % \vfill
        \newpage
    \fi

    \thispagestyle{empty} % Keep the disclaimer page clean
    \vspace*{\fill}
    ...
    \rule{\textwidth}{0pt}
    \vfill
    \begin{backpagenotice}
        These notes are a byproduct of my learning process - mistakes, bad jokes and snark included. If you take an error of mine as gospel and ruin your perfect 1st, that is a \textit{you} problem boo. I am a student, not a prophet, use a textbook if you want certainty.
    ...
    \end{backpagenotice}
    \vspace{2em}
    \small{Thomas Boxall is a Computer Science Student studying at the University of Portsmouth, UK. In all honesty, he should probably be revising or doing some work towards his dissertation, not fondling the template of his notes again. You can find Thomas online at thomasboxall.net} 
}
