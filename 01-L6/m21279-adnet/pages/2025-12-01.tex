...
\begin{itemize}
    \item C1 (Horizontal): 3700MHz - 3740MHz (CF 3720MHz)
    \item C2 (Vertical): 3720MHz - 3760MHz (CF 3740MHz)
    \item C3 (Horizontal): 3740MHz - 3780MHz (CF 3760MHz)
    \item C4 (Vertical): 3760MHz - 3800MHz (CF 3780MHz)
    \item etc...
\end{itemize}
