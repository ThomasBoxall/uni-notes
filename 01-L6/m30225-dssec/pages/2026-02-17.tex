...
The big shortcoming Vector clocks overcome is that in a Lamport clock $L(e) < L(e')$ does not necessarily mean that $e \rightarrow e'$. This can be shown in Vector clocks clearer through the vector representation of each process / event. In the same vain, Lamport clocks cannot spot concurrency; however Vector clocks can do. 
