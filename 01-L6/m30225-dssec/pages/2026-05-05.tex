...
The record protocol adds a secure communications layer below existing application-level protocols which is typically used to secure HTTP interactions for internet commerce and other security-sensitive applications. It is implemented by virtually all web browsers and web servers.
...
\begin{itemize}
    ...
    \item All handshake messages after the ServerHello are now encrypted. The newly introduced EncryptedExtensions message allows various extensions previously sent in the clear in the ServerHello to be protected 
