...
Causal Consistency is where related (casually dependent) writes must be seen in order and immediately, but independent writes can take place in any order. In a single distributed system network it is likely there will be a mix of dependent and independent nodes. The dependent nodes will all get the updates immediately while there might be delays for the independent nodes to receive updates. The independent nodes will eventually update to become synchronised.
