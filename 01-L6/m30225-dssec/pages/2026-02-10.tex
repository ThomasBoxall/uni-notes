...
The communication models used in Distributed Systems define how different processes and nodes (systems) interact with each other. The models influence the design of the system, as well as its efficiency and reliability. One model used may feed communications to another model, and therefore a different system. 
