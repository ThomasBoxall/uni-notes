...
SOAP has been designed to be platform and operating system independent. SOAP works n the HTTP protocol which is the default protocol used by all web applications, hence there is no platform specific configuration required to run web services built on the SOAP protocol to work on the internet. 
