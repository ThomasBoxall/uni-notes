...
The input string is represented on the tape by placing the letters of the string (which have come from $\Sigma$) into adjacent cells. All other cells of the tape contain the blank symbol. The head is usually positioned over the leftmost cell of the input string, which is the leftmost non-blank tape symbol. 
...
\begin{itemize}
    ...
    \item What state is the control in?
\end{itemize}
