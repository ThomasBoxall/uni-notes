...
\begin{figure}[H]
        ...
        \begin{tikzpicture}[node distance= 1.5cm,]
            ...
            \node[graphnodesml, draw] (rtl) [right of=tr]{};
            \node[graphnodesml, draw] (rbl) [below of=rtl] {};
            \node[graphnodesml, draw] (rbr) [right of=rbl] {};
            \node[graphnodesml, draw] (rtr) [above of=rbr] {};
            ...
            \draw (rtl) -- (rbl) node [midway, left] {1};
            \draw (rbl) -- (rbr) node [midway, below] {1};
            \draw (rbr) -- (rtr) node [midway, right] {2};
            \draw (rtr) -- (rtl) node [midway, above] {1};
            \draw (rtl) -- (rbr) node [pos=0.25, below] {2};
            \draw (rbl) -- (rtr) node [pos=0.65, above] {1};

        \end{tikzpicture}
        \caption{Original graph (left); transformed graph (right)}
    \end{figure}
