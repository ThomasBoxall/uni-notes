...
%IMG: undirected graph adjacency matrix
...
% IMG: directed graph and its adjacency matrix

For weighted graphs, the element is either the weight of the graph or infinity (\infty)

%IMG: weighted graph and its adjacency matrix
